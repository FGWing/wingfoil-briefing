...
### Welke 3 dagen, en hoe genoemd (geldt voor beide briefings)
Gebruik in de output (zowel het "Snel overzicht" als de "Komende 72 uur"
-secties in sjabloon.md) voor de eerste 3 dagen ALTIJD alleen de expliciete
dagnaam (bv. "woensdag") -- geen datum nodig, en nooit de labels
"Vandaag/Morgen/Overmorgen". Reden: bij de avondbriefing (23:15) zou
"Vandaag" verwarrend zijn, omdat de dag dan al bijna voorbij is en het
venster van die dag (meestal) allang gepasseerd is; de dagnaam alleen is
voor deze 3 dagen ondubbelzinnig genoeg.

Voor de "beste dag in de 7 dagen erna" WEL de volledige datum gebruiken
(dag + dag-van-maand + maand, bv. "woensdag 19 augustus") -- die dag ligt
verder in de toekomst en is minder vanzelfsprekend te herleiden uit de
context, dus daar is de volledige datum wel nodig.

De eerste 3 regels/secties zijn simpelweg de eerstvolgende 3 volle dagen
gerekend vanaf het moment van versturen:
- Bij de OCHTENDBRIEFING (07:15): dat zijn de huidige dag + de 2 dagen erna.
- Bij de AVONDBRIEFING (23:15): dat zijn de eerstvolgende volle dag (dus
  praktisch "morgen") + de 2 dagen daarna -- de huidige dag (met nog een
  half uur te gaan) wordt NIET als aparte regel getoond.
- De "beste dag in de 7 dagen erna" sluit hierop aan: dat blijft dag 4 t/m
  9 gerekend vanaf de huidige kalenderdag, ongeacht ochtend of avond.
